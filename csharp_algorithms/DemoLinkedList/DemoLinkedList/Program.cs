...
/// <summary>
/// The following code is a demo for several fetures of the LikedList<T> class.
/// </summary>
namespace DemoLinkedList
{
    class Program
    {
        ...
        private static void IndicateNode(LinkedListNode<string> node, string test)
        {
            ...
            // build before the target node by going back
            while (nodeP != null)
            {
            ...
            //build after the target node by going forward
            while (node != null)
            {
